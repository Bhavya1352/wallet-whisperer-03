      ...
      <section className="py-16 bg-gradient-to-br from-background to-secondary/20">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose Wallet Whisperer?</h2>
            <p className="text-gray-600">Experience the future of personal finance management</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center group hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-600 text-sm">Watch your dashboard populate as you add transactions. Instant visual feedback!</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center group hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-gray-600 text-sm">Your financial data is encrypted and stored securely. Privacy first approach.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg text-center group hover:shadow-xl transition-all duration-300 hover:scale-105">
              ...
              <h3 className="font-semibold mb-2 text-lg">Smart Goals</h3>
              <p className="text-gray-600 text-sm">Set and track your financial goals with intelligent insights and progress tracking.</p>
            </div>
          </div>
        </div>
      </section>
